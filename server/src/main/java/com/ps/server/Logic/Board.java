    ...
    public void makeMove(Move move) {
        ...
        switch (move.type) {
            case PROMOTION:
                removePiece(dest);
                removePiece(loc);
                Piece piece = Piece.createPiece(move.getPromoteTo(), dest, move.pieceColor);
                addPiece(piece, dest);
                if (move.pieceColor == Color.BLACK) {
                    blackSet.addPieceToSet(piece, this);
                } else if (move.pieceColor == Color.WHITE) {
                    whiteSet.addPieceToSet(piece, this);
                }
                break;
            case EN_PASSANT:
